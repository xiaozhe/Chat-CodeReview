...
diff_content = "" \
"@@ -393,3 +393,13 @@ void Tools_Widget::setTabOrder(Define_Config *_config, QWidget *_parent)\n" \
"       }\n" \
"    }\n" \
"}\n" \
"\n" \
"void SetKeyOnEvent(void *EventHandle)\n" \
"{\n" \
"    EVENT_HANDLE *handle = (EVENT_HANDLE *) EventHandle;\n" \
"    if (handle){\n" \
"        handle->KeyBegin = my_get boot time _ms();\n" \
"        handle->KeyOn = 1;\n" \
"        handle->KeyRunFlag = 2;\n" \
"    }\n" \
"}"
